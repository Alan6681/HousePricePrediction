...
class TrainingPipeline:
    ...
    def start_data_validation(self, data_ingestion_artifact:DataIngestionArtifact):
        try:
            self.data_validation_config = DataValidationConfig(training_pipeline_config=self.training_pipeline_config, data_ingestion_config=self.data_ingestion_config)
    ...
    def start_data_transformation(self, data_validation_artifact:DataValidationArtifact):
        try:
            ...
            data_transformation = DataTransformation(data_validation_config=self.data_validation_config, data_validation_artifact=data_validation_artifact, data_transformation_config=self.data_transformation_config)
